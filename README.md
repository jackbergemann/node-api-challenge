...
- [ ] Mention two parts of Express that you learned about this week.
    ...
    The benifits of Express middleware

- [ ] Describe Middleware?
    Different functions that help utilize your code. It invokes in the order they are listed.

- [ ] Describe a Resource?
    A resource is any object the code is working with. 

- [ ] What can the API return to help clients know if a request was successful?
    Status codes.

- [ ] How can we partition our application into sub-applications?
    Use routers to specify what parts of our application fires depending upon the url.
